...
UPLOAD_FOLDER = r'C:\Users\aksha\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\static\IMAGE_FILES'
...
def upload_file():
    data = []
    for i in os.listdir(
            r'C:\Users\aksha\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\static\IMAGE_FILES'):
        temp = "/IMAGE_FILES/" + i
        name = i.split(".")[0]
        data.append([temp, name])
    print(data)
    return render_template('upload.html',image_list = data)
...
def gen():
    IMAGE_FILES = []
    filename = []
    dir_path = r'C:\Users\aksha\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\static\IMAGE_FILES'
